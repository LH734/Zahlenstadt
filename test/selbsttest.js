...
(function (root) {
  ...
  const NIVEAU_NAME = { 1: 'Niveau 1 · Etappe 1–3', 2: 'Niveau 2 · Etappe 4–5', 3: 'Niveau 3 · ab Etappe 6' };
  const median = liste => {
   ...
   * und Niveau 1 < Niveau 3. Großbauwerk von Etappe 5 läuft auf Niveau 2, ab Etappe 6 auf Niveau 3.
   */
