...
(function (root) {
  ...
  /** Anstieg über die Etappen: Niveau 1 = Tutorial und Etappe 1–2, 2 = Etappe 3–4, 3 = ab Etappe 5 */
  function niveau(z) {
    if (z.phase === 'tutorial' || z.etappe <= 2) return 1;
    return z.etappe <= 4 ? 2 : 3;
  }
  ...
  function aufgabeBeendet(z, hatteFehler, ereignisse) {
    ...
    if (z.serieRichtig >= RICHTIG_FUER_HOCH && i < STUFEN.length - 1) {
      z.stufe = STUFEN[i + 1];
      z.serieRichtig = 0;
  ...
  root.Spiel = {
    VERSION, SCHLUESSEL, SPERRE_MS, KARTE_MS, AUTOMATIK_PAUSE, STUFEN,
